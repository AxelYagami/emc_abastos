{{-- 
    CLASSIC TEMPLATE - EMC Abastos Storefront
    Traditional e-commerce layout with hero slider, search, and grid
    Best for: Food/grocery stores, traditional markets
--}}
    ...
    <div class="max-w-7xl mx-auto">
        ...
        @if($q || $categoriaId)
            <div class="mb-6 flex items-center justify-between">
                ...
                <a href="{{ url()->current() }}" class="text-sm font-medium hover:underline" style="color: var(--brand-primary);">
                    Limpiar filtros
                </a>
            </div>
        @endif
