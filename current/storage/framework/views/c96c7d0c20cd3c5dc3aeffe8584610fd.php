...
<div x-data="dashboardChart()" x-init="initChart()">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-5 hover:shadow-md transition">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-2xl font-bold text-gray-900 mt-1">$<?php echo e(number_format($kpis['ventas_hoy'], 2)); ?></p>
        </div>
      ...
      <div class="mt-2 text-xs text-gray-500">
        <span class="text-primary-600 font-medium"><?php echo e($kpis['ordenes_hoy']); ?></span> órdenes
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-5 hover:shadow-md transition">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-2xl font-bold text-gray-900 mt-1">$<?php echo e(number_format($kpis['ventas_semana'], 2)); ?></p>
        </div>
      ...
      <div class="mt-2 text-xs text-gray-500">
        <span class="text-blue-600 font-medium"><?php echo e($kpis['ordenes_semana']); ?></span> órdenes
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-5 hover:shadow-md transition">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-2xl font-bold text-gray-900 mt-1">$<?php echo e(number_format($kpis['ventas_mes'], 2)); ?></p>
        </div>
      ...
      <div class="mt-2 text-xs text-gray-500">
        <span class="text-purple-600 font-medium"><?php echo e($kpis['ordenes_mes']); ?></span> órdenes
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border p-5 hover:shadow-md transition">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-2xl font-bold text-gray-900 mt-1">$<?php echo e(number_format($kpis['ticket_promedio_mes'], 2)); ?></p>
        </div>
      ...
      <div class="mt-2 text-xs text-gray-500">
        Hoy: <span class="text-amber-600 font-medium">$<?php echo e(number_format($kpis['ticket_promedio_hoy'], 2)); ?></span>
      </div>
    </div>
  </div>
  ...
  <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
    ...
    <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-sm p-4 text-white">
      <div class="flex items-center gap-3">
        ...
        <div>
          <p class="text-2xl font-bold"><?php echo e($kpis['pendientes']); ?></p>
    ...
    <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-sm p-4 text-white">
      <div class="flex items-center gap-3">
        ...
        <div>
          <p class="text-2xl font-bold"><?php echo e($kpis['entregadas']); ?></p>
    ...
    <div class="bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl shadow-sm p-4 text-white">
      <div class="flex items-center gap-3">
        ...
        <div>
          <p class="text-2xl font-bold"><?php echo e($kpis['productos_activos']); ?></p>
    ...
    <div class="bg-gradient-to-br from-pink-500 to-pink-600 rounded-xl shadow-sm p-4 text-white">
      <div class="flex items-center gap-3">
        ...
        <div>
          <p class="text-2xl font-bold"><?php echo e($kpis['clientes']); ?></p>
  ...
  <div class="grid lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-xl shadow-sm border p-6">
      <div class="flex items-center justify-between mb-4">
        ...
        <a href="<?php echo e(route('ops.ordenes.hoy')); ?>" class="text-sm text-primary-600 hover:text-primary-700 font-medium">Ver todas</a>
      </div>
      <div class="space-y-3">
        <?php $__empty_1 = true; $__currentLoopData = $ultimasOrdenes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $o): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <div class="flex items-center justify-between py-2 border-b last:border-0">
            <div class="min-w-0">
              <p class="font-medium text-gray-800 truncate"><?php echo e($o->folio ?? '#'.$o->id); ?></p>
              <p class="text-xs text-gray-500">
                ...
                ?>
                <span class="<?php echo e($statusColors[$o->status] ?? 'text-gray-600'); ?>"><?php echo e(ucfirst($o->status)); ?></span>
                · <?php echo e($o->created_at->format('d/m H:i')); ?>

              </p>
            </div>
            <p class="font-bold text-gray-900">$<?php echo e(number_format($o->total, 2)); ?></p>
          </div>
  ...
  <div class="mt-6 bg-white rounded-xl shadow-sm border p-6">
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
      <a href="<?php echo e(route('admin.productos.index')); ?>" class="flex items-center gap-3 p-3 rounded-lg border hover:bg-primary-50 hover:border-primary-200 transition group">
      ...
      <a href="<?php echo e(route('admin.categorias.index')); ?>" class="flex items-center gap-3 p-3 rounded-lg border hover:bg-primary-50 hover:border-primary-200 transition group">
      ...
      <a href="<?php echo e(route('admin.caja.index')); ?>" class="flex items-center gap-3 p-3 rounded-lg border hover:bg-primary-50 hover:border-primary-200 transition group">
      ...
      <a href="<?php echo e(route('ops.ordenes.hoy')); ?>" class="flex items-center gap-3 p-3 rounded-lg border hover:bg-primary-50 hover:border-primary-200 transition group">
      ...
      <a href="<?php echo e(route('admin.whatsapp.index')); ?>" class="flex items-center gap-3 p-3 rounded-lg border hover:bg-primary-50 hover:border-primary-200 transition group">
      ...
      <a href="<?php echo e(route('admin.inventarios.index')); ?>" class="flex items-center gap-3 p-3 rounded-lg border hover:bg-primary-50 hover:border-primary-200 transition group">
...
<?php echo $__env->make('layouts.admin', ['title'=>'Dashboard','header'=>'Dashboard'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\sites\emc_abastos\current\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>